...
<link href="css/signup_css.css" rel="stylesheet">
    ...
    <body style="font-family:tahoma; background-color:#e9ebee;">
        ...
        <form id="login_form" method="POST" action="">
            ...
            $captcha = new Captcha();
            $captcha->display();
            $word_captcha=$captcha->create_image();
            $_POST['word_captcha'] = $word_captcha;
            echo '<input type="hidden" value=' . $word_captcha . ' name="word_captcha">'; 

            ?>
            <input type="text" placeholder="CAPTCHA" id="captcha_id" name="captcha"> <br><br>
